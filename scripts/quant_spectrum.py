...
#peak_centers, peak_prop = find_peaks(y, height=1, prominence=0.5,rel_height=0.9)
#widths, width_heights, peak_lefts, peak_rights = peak_widths(y, peak_centers,rel_height=0.85)
...
wareas = [areas[i] / sensitivity_factors[species[i]] for i in range(len(areas))]
